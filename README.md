...
<div>
   <table>
      <td width="60%" valign="top">
         <h5 >До запуска игры необходимо наличие всех игроков в базе данных</h5>
         Используем команду <b>new_player</b> или кнопку "<b>🦈 Добавить игрока</b>" при старте бота и вводим ник игрока
      </td>
      <td width="40%">
    ...
    <tr>
      <td width="60%" valign="top" >
        <ol>
          ...
          Бот поэтапно запросить ввести количество фишек у оставшихся игроков→<br>
          Отправляем количество фишек на выходе<br>
