    ...
    <tr>
      <td width="60%" valign="top" >
        <ol>
          ...
          <ol>
             <li>Нажимаем "Добавить игрока 🎣"</li>
             <li>Выбираем из списка нужного игрока</li>
             <img src="assets/add_player.jpg" alt="Таблица учета игры">
          </ol>
          <li>Докупить игрока</li>
          <ol>
             <li>Нажимаем "Докупить игрока 💲"</li>
             <li>Выбираем из списка нужного игрока</li>
             <li>Выбираем количество фишек для докупа</li>
             <img src="assets/add_on.jpg" alt="Таблица учета игры">
          </ol>
          <li>Выход игрока из игры</li>
          <ol>
             <li>Нажимаем "Выход игрока 🚪"</li>
             <li>Выбираем из списка нужного игрока</li>
             <li>Отправляем количество фишек на выходе</li>
             <img src="assets/player_exit.jpg" alt="Таблица учета игры">
          </ol>
          <li>Окончание игры</li>
          <ol>
             <li>Нажимаем "Закончить игру 🔚"</li>
             <li>Бот поэтапно запросить ввести количество фишек у оставшихся игроков</li>
             <li>Отправляем количество фишек на выходе</li>
